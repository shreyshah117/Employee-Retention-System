CREATE TABLE "hr" (
  "satisfaction_level" double precision,
  "last_evaluation" double precision,
  "number_project" bigint,
  "average_montly_hours" bigint,
  "time_spend_company" bigint,
  "Work_accident" bigint,
  "employee_left" bigint,
  "promotion_last_5years" bigint,
  "sales" text,
  "salary" text
);

INSERT INTO "hr" ("satisfaction_level","last_evaluation","number_project","average_montly_hours","time_spend_company","Work_accident","employee_left","promotion_last_5years","sales","salary")
VALUES
